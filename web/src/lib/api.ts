...
export const api = {
  ...
  previewBulk: (payload: BulkActionRequest) => req<{ dry_run: true; preview: BulkActionPreview }>('POST', '/api/bulk', { ...payload, dry_run: true }),
  bulk: (payload: BulkActionRequest) => req<{ dry_run: false; results: BulkActionResult[] }>('POST', '/api/bulk', { ...payload, dry_run: false }),
