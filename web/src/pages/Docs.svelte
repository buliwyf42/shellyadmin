  ...
  <div class="col-lg-5">
    <div class="card bg-dark border-secondary">
      <div class="card-body">
        ...
        <ul class="mb-0">
          <li>
            Session/login endpoints, runtime metadata, inventory, device detail, and action
            discovery
          </li>
          <li>
            Scan, refresh, firmware, provisioning, and bulk settings workflows including `dry_run`
            previews
          </li>
          <li>
            Settings, templates, credentials, auth groups, logs, backup export/import, and the
    ...
    <div class="card bg-dark border-secondary">
      <div class="card-body">
        ...
        <p class="text-secondary">
          Fetch this directly from <code>/api/openapi/v1.json</code> for the current documented v1 route
          set used by tooling and automation.
        </p>
