...
>
  <div class="sa-form-grid">
    <div data-span="6">
      <FieldRow label="Device Name" bind:enabled={state.nameEnabled} disabled={!state.enabled}>
        <input
          ...
          disabled={!state.enabled || !state.nameEnabled}
        />
      </FieldRow>
    </div>
    <div data-span="6">
      <FieldRow label="Timezone" bind:enabled={state.tzEnabled} disabled={!state.enabled}>
        <input
          class="form-control"
          bind:value={state.tz}
          disabled={!state.enabled || !state.tzEnabled}
        />
      </FieldRow>
    </div>
    <div data-span="6">
      <FieldRow label="SNTP Server" bind:enabled={state.sntpEnabled} disabled={!state.enabled}>
        <input
          class="form-control"
          bind:value={state.sntp}
          disabled={!state.enabled || !state.sntpEnabled}
        />
      </FieldRow>
    </div>
    <div data-span="6">
      <FieldRow
        label="Debug WebSocket (stream logs)"
        bind:enabled={state.debugWSEnabled}
        disabled={!state.enabled}
      >
        <Toggle
          bind:checked={state.debugWS}
          disabled={!state.enabled || !state.debugWSEnabled}
    ...
    <div data-span="6">
      <FieldRow label="Debug MQTT" bind:enabled={state.debugMQTTEnabled} disabled={!state.enabled}>
        <Toggle
          ...
          disabled={!state.enabled || !state.debugMQTTEnabled}
    ...
    <div data-span="6">
      <FieldRow
        label="Debug UDP Host"
        bind:enabled={state.debugUDPHostEnabled}
        disabled={!state.enabled}
      >
        <input
          class="form-control"
          ...
          disabled={!state.enabled || !state.debugUDPHostEnabled}
        />
      </FieldRow>
    </div>
    <div data-span="6">
      <FieldRow
        label="RPC UDP Port (0 = off)"
        bind:enabled={state.rpcUDPPortEnabled}
        disabled={!state.enabled}
      >
        <input
          class="form-control"
          ...
          disabled={!state.enabled || !state.rpcUDPPortEnabled}
        />
      </FieldRow>
    </div>
    <div data-span="6">
      <FieldRow label="Latitude" bind:enabled={state.latEnabled} disabled={!state.enabled}>
        <input
          ...
          disabled={!state.enabled || !state.latEnabled}
        />
      </FieldRow>
    </div>
    <div data-span="6">
      <FieldRow label="Longitude" bind:enabled={state.lonEnabled} disabled={!state.enabled}>
        <input
          ...
          disabled={!state.enabled || !state.lonEnabled}
        />
      </FieldRow>
    </div>
    <div data-span="6">
      <FieldRow label="Eco Mode" bind:enabled={state.ecoEnabled} disabled={!state.enabled}>
        <Toggle
          ...
          disabled={!state.enabled || !state.ecoEnabled}
    ...
    <div data-span="6">
      <FieldRow
        label="Discoverable"
        bind:enabled={state.discoverableEnabled}
        disabled={!state.enabled}
      >
        <Toggle
          bind:checked={state.discoverable}
          disabled={!state.enabled || !state.discoverableEnabled}
